...
from MarkdownTools import MarkdownValidationTool
...
def process_markdown_document(filename):
    ...
    syntax_review_task = Task(description=f"""
            ...
            expected_output="""
            A concise, developer-ready list of markdown linting issues expressed as actionable tasks.
            """,
            agent=general_agent)
